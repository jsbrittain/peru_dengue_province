...
dir.create(file.path("~/.cache/R/gb_cache"),
...
peru_district_boundaries2 <- st_read(file.path(peru.province.data.dir,
...
if (!xargs$dry_run) {
  # Vector (each element is the extracted mean for a province)
