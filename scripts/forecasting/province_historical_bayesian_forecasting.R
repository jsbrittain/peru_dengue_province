...
file_names <- paste0(peru.province.inla.data.out.dir, '/', filestem, 1:(province_first_time_2018 - 1), ".RDS.trigger")
file.create(file_names)

# Launch Snakemake to process province_historical_bayesian_forecasting_pre.RData
log_info("Launch Snakemake to process province_historical_bayesian_forecasting_pre")
current_folder <- getwd()
setwd("../..")
system2("snakemake",
  args = c("--cores", "4", "--snakefile", "workflows/forecasting/phbf/phbf.smk"),
