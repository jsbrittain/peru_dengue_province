...
historical_sarima_preds_dt <- melt(raw_historical_sarima_preds_dt, id.vars = c("IND",
    "PROVINCE"), variable.name = "SAMPLE", value.name = "prediction")
...
historical_sarima_preds_dt_for_scoring <- subset(historical_sarima_preds_dt, select = c("location",
...
setnames(historical_fine_tuned_timegpt_preds_dt, colnames(historical_fine_tuned_timegpt_preds_dt)[4:26],
    tmp_quantiles)
...
historical_fine_tuned_timegpt_preds_dt <- merge(historical_fine_tuned_timegpt_preds_dt,
    ptl_province_2010_2018_data, by = c("PROVINCE", "end_of_month"))
...
tmp[, MEDIAN := NULL]
quantile_historical_fine_tuned_timegpt_preds_dt <- melt(tmp, id.vars = c("PROVINCE",
    "LOG_CASES", "end_of_month", "POP_OFFSET"), variable.name = "quantile", value.name = "prediction")
quantile_historical_fine_tuned_timegpt_preds_dt[, quantile := gsub("q_", "", quantile)]
quantile_historical_fine_tuned_timegpt_preds_dt[, quantile := gsub("TimeGPT",
    0.5, quantile)]
...
quantile_historical_fine_tuned_timegpt_preds_dt <- quantile_historical_fine_tuned_timegpt_preds_dt[which(quantile !=
    "TimeGPT")]
setnames(quantile_historical_fine_tuned_timegpt_preds_dt, c("PROVINCE", "LOG_CASES",
    "end_of_month"), c("location", "true_value", "target_end_date"))
...
setnames(historical_no_covars_fine_tuned_timegpt_preds_dt, colnames(historical_no_covars_fine_tuned_timegpt_preds_dt)[4:26],
    tmp_quantiles)
ptl_province_2010_2018_data <- subset(ptl_province_inla_df, YEAR < 2018)
ptl_province_2010_2018_data <- subset(ptl_province_2010_2018_data, end_of_month >=
...
historical_no_covars_fine_tuned_timegpt_preds_dt[, caret::MAE(TimeGPT, LOG_CASES),
    by = "PROVINCE"]
historical_no_covars_fine_tuned_timegpt_preds_dt[, caret::MAE(expm1(TimeGPT)/POP_OFFSET,
    DIR)]
historical_no_covars_fine_tuned_timegpt_preds_dt[, caret::R2(expm1(TimeGPT)/POP_OFFSET,
    DIR)]
...
tmp <- subset(tmp, select = c(colnames(tmp)[1:26], "LOG_CASES", "POP_OFFSET"))
tmp[, MEDIAN := NULL]
quantile_historical_no_covars_fine_tuned_timegpt_preds_dt <- melt(tmp, id.vars = c("PROVINCE",
    "LOG_CASES", "end_of_month", "POP_OFFSET"), variable.name = "quantile", value.name = "prediction")
quantile_historical_no_covars_fine_tuned_timegpt_preds_dt[, quantile := gsub("q_",
    "", quantile)]
quantile_historical_no_covars_fine_tuned_timegpt_preds_dt[, quantile := gsub("TimeGPT",
    0.5, quantile)]
...
quantile_historical_no_covars_fine_tuned_timegpt_preds_dt <- quantile_historical_no_covars_fine_tuned_timegpt_preds_dt[which(quantile !=
    "TimeGPT")]
setnames(quantile_historical_no_covars_fine_tuned_timegpt_preds_dt, c("PROVINCE",
    "LOG_CASES", "end_of_month"), c("location", "true_value", "target_end_date"))
...
historical_tcn_preds_dt <- melt(raw_historical_tcn_preds_dt, id.vars = c("IND", "PROVINCE"),
...
historical_tcn_preds_dt_for_scoring <- subset(historical_tcn_preds_dt, select = c("location",
    "sample", "true_value", "prediction", "model", "end_of_month"))
...
finetuned_no_covars_timegpt_preds_dt <- merge(finetuned_no_covars_timegpt_preds_dt,
    ptl_province_2018_2021_data, by = c("PROVINCE", "IND", "end_of_month"))
# print(finetuned_no_covars_timegpt_preds_dt)
...
tmp <- subset(tmp, select = c("PROVINCE", "IND", "end_of_month", paste0("TimeGPT.q.",
    gpt_quantiles), "YEAR", "MONTH", "TIME", "LOG_CASES", "POP_OFFSET"))
quantile_finetuned_no_covars_timegpt_preds_dt <- melt(tmp, id.vars = c("PROVINCE",
    "IND", "TIME", "MONTH", "YEAR", "LOG_CASES", "end_of_month", "POP_OFFSET"), variable.name = "quantile",
    value.name = "prediction")
quantile_finetuned_no_covars_timegpt_preds_dt <- quantile_finetuned_no_covars_timegpt_preds_dt[which(quantile !=
    "TimeGPT")]
setnames(quantile_finetuned_no_covars_timegpt_preds_dt, c("PROVINCE", "LOG_CASES",
    "end_of_month"), c("location", "true_value", "target_end_date"))
...
num_repeats_for_each_quantile <- unique(quantile_finetuned_no_covars_timegpt_preds_dt[,
    length(IND), by = "quantile"]$V1)
num_repeats_for_each_quantile

quantile_finetuned_no_covars_timegpt_preds_dt[, quantile := rep(c(0.01, 0.025,
    seq(0.05, 0.95, 0.05), 0.975, 0.99), each = num_repeats_for_each_quantile)]
...
tmp <- subset(tmp, select = c("PROVINCE", "IND", "end_of_month", paste0("TimeGPT.q.",
    gpt_quantiles), "YEAR", "MONTH", "TIME", "LOG_CASES", "POP_OFFSET"))
quantile_fine_tuned_timegpt_preds_dt <- melt(tmp, id.vars = c("PROVINCE", "IND",
    "TIME", "MONTH", "YEAR", "LOG_CASES", "end_of_month", "POP_OFFSET"), variable.name = "quantile",
    value.name = "prediction")
quantile_fine_tuned_timegpt_preds_dt <- quantile_fine_tuned_timegpt_preds_dt[which(quantile !=
    "TimeGPT")]
setnames(quantile_fine_tuned_timegpt_preds_dt, c("PROVINCE", "LOG_CASES", "end_of_month"),
...
quantile_fine_tuned_timegpt_preds_dt[, quantile := rep(c(0.01, 0.025, seq(0.05,
    0.95, 0.05), 0.975, 0.99), each = num_repeats_for_each_quantile)]
...
raw_tcn_preds_dt[, IND := rep(seq(1, length(unique(ptl_province_2018_2021_data$TIME))),
    each = 2500), by = "PROVINCE"]
raw_tcn_preds_dt
raw_tcn_preds_dt <- merge(raw_tcn_preds_dt, ptl_province_2018_2021_data, by = c("PROVINCE",
    "IND"))
...
raw_tcn_preds_dt_for_scoring <- subset(raw_tcn_preds_dt, select = c("location", "sample",
...
quantile_tcn_preds_dt <- sample_to_quantile(raw_tcn_preds_dt_for_scoring, quantiles = c(0.01,
...
dir_tcn_preds_dt_for_scoring <- subset(dir_tcn_preds_dt, select = c("location", "sample",
...
summary_tcn_preds_dt <- raw_tcn_preds_dt[, list(CI_L = quantile(prediction, probs = 0.025,
    na.rm = TRUE), CI_U = quantile(prediction, probs = 0.975, na.rm = TRUE), MEDIAN = median(prediction,
    na.rm = TRUE), MEAN = mean(prediction, na.rm = TRUE), true_value = unique(true_value),
    true_DIR = unique(DIR), DIR_CI_L = quantile(DIR_prediction, probs = 0.025, na.rm = TRUE),
    DIR_CI_U = quantile(DIR_prediction, probs = 0.975, na.rm = TRUE), DIR_MEDIAN = quantile(DIR_prediction,
        0.5), OUTBREAK_PROB_50 = length(which(DIR_prediction >= 50 & !is.na(prediction)))/length(which(!is.na(prediction))),
...
raw_sarima_preds_dt[, IND := rep(seq(1, length(unique(ptl_province_2018_2021_data$TIME))),
    each = 2500), by = "PROVINCE"]
raw_sarima_preds_dt
raw_sarima_preds_dt <- merge(raw_sarima_preds_dt, ptl_province_2018_2021_data, by = c("PROVINCE",
    "IND"))
...
raw_sarima_preds_dt_for_scoring <- subset(raw_sarima_preds_dt, select = c("location",
    "sample", "true_value", "prediction", "model", "end_of_month"))
...
quantile_sarima_preds_dt <- sample_to_quantile(raw_sarima_preds_dt_for_scoring, quantiles = c(0.01,
    0.025, seq(0.05, 0.95, 0.05), 0.975, 0.99))
...
dir_sarima_preds_dt_for_scoring <- subset(dir_sarima_preds_dt, select = c("location",
...
summary_sarima_preds_dt <- raw_sarima_preds_dt[, list(CI_L = quantile(prediction,
    probs = 0.025, na.rm = TRUE), CI_U = quantile(prediction, probs = 0.975, na.rm = TRUE),
    ...
    true_value = unique(true_value), true_DIR = unique(DIR), DIR_CI_L = quantile(DIR_prediction,
        probs = 0.025, na.rm = TRUE), DIR_CI_U = quantile(DIR_prediction, probs = 0.975,
        na.rm = TRUE), DIR_MEDIAN = median(DIR_prediction), OUTBREAK_PROB_50 = length(which(DIR_prediction >=
        50 & !is.na(prediction)))/length(which(!is.na(prediction))), OUTBREAK_PROB_150 = length(which(DIR_prediction >=
        150 & !is.na(prediction)))/length(which(!is.na(prediction)))), by = c("PROVINCE",
