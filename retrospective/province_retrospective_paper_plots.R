...
ggsave(recons_urban_plot_grob, 
       file = file.path(peru.province.wavelet.out.dir,
                        "recons_urban_plot_grob.pdf"), h = 12, w = 24)
...
ggsave(multi_cycle_corr_plots, file = file.path(peru.province.wavelet.out.dir,
                                                            "multi_cycle_corr_plots.pdf"), h = 12, w = 24)
...
ggsave(monthly_dir_plots, file = file.path(peru.province.out.dir,
                                           "monthly_dir_plots.pdf"), h = 12, w = 22)

monthly_longitude_plot_by_year
ggsave(monthly_longitude_plot_by_year, file = file.path(peru.province.out.dir,
                                           "monthly_longitude_plot_by_year.pdf"), 
       h = 14, w = 22)
ggsave(monthly_latitude_plot_by_year, file = file.path(peru.province.out.dir,
...
avg_wavelet_power_plots <- ggarrange(longitude_avg_wavelet_power_plot, 
          latitude_avg_wavelet_power_plot, common.legend = TRUE,
          legend = "bottom")
ggsave(avg_wavelet_power_plots, file = file.path(peru.province.out.dir,
                                                         "avg_wavelet_power_plots.pdf"), h = 12, w = 22)
ggsave(avg_wavelet_power_plots, file = file.path(peru.province.out.dir,
                                                         "avg_wavelet_power_plots.png"), h = 12, w = 22)
...
annual_multi_recons_coherency_plot_list <- 
  list(tmax_annual_recons_coherency_plot, 
       tmax_multi_recons_coherency_plot, 
       prec_annual_recons_coherency_plot,
       prec_multi_recons_coherency_plot)
annual_multi_recons_coherency_plot_list
ggarrange(plotlist = annual_multi_recons_coherency_plot_list, nrow = 2,
          ncol = 2,
          common.legend = TRUE, legend = "bottom")
...
ggarrange(plotlist = tmax_prec_icen_coherency_cross_wave_list, nrow = 2,
          ncol = 2,
          common.legend = TRUE, legend = "bottom")


tmax_annual_recons_cross_wave_coherency_grid <- ggarrange(tmax_annual_recons_coherency_plot, tmax_annual_recons_cross_wave_plot, nrow = 1,
...
prec_annual_recons_cross_wave_coherency_grid <- ggarrange(prec_annual_recons_coherency_plot, prec_annual_recons_cross_wave_plot, nrow = 1,
                                                          labels = c("A)", "B)"), hjust = -1.5,
                                                          font.label = list(size = 26, face = "bold"))
...
dist_cross_wave_tmax_prec_icen_plot <- 
  ggarrange(distribution_cross_power_tmax_annual_plot + xlab("") + ylab("")+
          ...
          distribution_cross_power_icen_annual_plot + ylab("") + scale_y_continuous(breaks = seq(0, 15, by = 5)) +
            coord_cartesian(ylim=c(0, 10), expand = T),nrow = 3,
          hjust = -2.5,
...
dist_cross_wave_tmax_prec_icen_multi_plot <- 
  ggarrange(distribution_cross_power_tmax_multi_plot + xlab("") + ylab("")+
            ...
            distribution_cross_power_icen_multi_plot + ylab("") + 
              coord_cartesian(ylim=c(0, 4.5), expand = T) + scale_y_continuous(breaks = seq(0, 4.5, by = 1.5)),nrow = 3,
            hjust = -2.5,
            labels = c("A)", "B)", "C)"), font.label = list(size = 26, face = "bold"))
dist_cross_wave_tmax_prec_icen_multi_plot
